    ...
    return (
        <div className=" grid grid-cols-1 my-20">
          <div className="relative max-w-[350px] group">
            <img className="rounded-lg transform scale-105" src={image} alt="card navigate ui" />
          ...
          <div className="bg-white space-y-12  max-w-[350px] rounded-tr-lg rounded-br-lg md:w-[350px] text-center p-10 shadow-[0px_7px_30px_2px_rgba(100,100,111,0.2)]">
            ...
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                <p className="text-gray-500 text-sm font-sans">Floor</p>
                <p className="text-3xl tracking-wider text-gray-700">{floor_no}</p>
              </div>
              <div className="space-y-1">
                <p className="text-gray-500 text-sm font-sans">Apartment</p>
                <p className="text-3xl tracking-wider text-gray-700">{apartment_no}</p>
              </div>
              <div className="space-y-1">
                <p className="text-gray-500 text-sm font-sans">Rent (BDT)</p>
                <p className="text-3xl tracking-wider text-gray-700">{rent}</p>
              </div>
            </div>
            <div>
